...
const Nav = () => {
	...
	return (
		<nav className="z-[1] flex p-[0.5%] xl:p-[1%] 2xl:p-[1.5%] text-white justify-between items-center w-full">
			...
			<div
				id="github-star"
				className="flex py-1 px-[0.38rem] rounded-md duration-500"
				style={{
					background: 'transparent',
					boxShadow: 'inset 0 0 0 1px yellow, inset 0 0 0 2px orange'
				}}
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 576 512"
					className="h-4 w-4 fill-[#F0970E] [margin-inline-end:4px]  self-center"
				>
