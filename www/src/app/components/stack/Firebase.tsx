...
export default function Firebase() {
  return (
    <div className="group relative overflow-hidden cursor-wait border-dashed hover:rounded-xl duration-300 shadow-[inset_0_0_3rem_#FFCA2844] border-[#FFCA28]/70 bg-[#FFCA28]/10 backdrop-blur-sm border text-[#FFEA48]/80 p-4 sm:pr-8 flex-grow rounded-3xl flex flex-col items-start">
      <Image
