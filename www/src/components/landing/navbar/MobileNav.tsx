  ...
  return (
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetTrigger asChild>
        <Button
          variant="ghost"
          className="mr-2 px-0 text-base hover:bg-transparent focus-visible:bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 sm:hidden flex absolute right-4"
        >
          <Menu />
